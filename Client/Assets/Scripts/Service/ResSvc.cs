...
public class ResSvc : MonoBehaviour
{
    ...
    public void InitSvc()
    {
        ...
        Instance = this;
        InitRandomNameCfg(PathDefine.RandomNameCfg);
    ...
    public GameObject LoadPrefab(string path, Vector3 position, bool cache = false)
    {
    ...
    public string GetRandomNameData(bool man = true)
    {
