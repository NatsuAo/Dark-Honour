    ...
    private void RefreshUI()
    {
        switch (endType)
        {
            ...
            case FBEndType.Win:
                ...
                SetText(txtTime, $"通过时间：{min}:{sec}");
                SetText(txtRestHP, $"剩余血量：{resthp}");
                SetText(txtReward, $"关卡奖励：{Constants.Color(coin + "金币", TxtColor.Green)}," +
                    $"{Constants.Color(exp + "经验", TxtColor.Yellow)},{Constants.Color(crystal + "水晶", TxtColor.Blue)}");
