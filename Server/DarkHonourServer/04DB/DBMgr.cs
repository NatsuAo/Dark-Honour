...
public class DBMgr
{
    ...
    private int InsertNewAcctData(string acct, string pass, PlayerData pd)
    {
        ...
        try
        {
            MySqlCommand cmd = new MySqlCommand("insert into account set acct=@acct,pass =@pass,name=@name,level=@level,exp=@exp,power=@power," +
                "coin=@coin,diamond=@diamond,hp=@hp,ad=@ad,ap=@ap,addef=@addef,apdef=@apdef,dodge=@dodge,pierce=@pierce,critical=@critical,guideid=@guideid," +
                "strong=@strong,crystal=@crystal,time=@time,task=@task,fuben=@fuben", conn);
            cmd.Parameters.AddWithValue("acct", acct);
    ...
    public bool UpdatePlayerData(int id, PlayerData playerData)
    {
        try
        {
            ...
            "update account set name=@name,level=@level,exp=@exp,power=@power,coin=@coin,diamond=@diamond,hp=@hp," +
            "ad=@ad,ap=@ap,addef=@addef,apdef=@apdef,dodge=@dodge,pierce=@pierce,critical=@critical,guideid=@guideid," +
            "strong=@strong,crystal=@crystal,time=@time,task=@task,fuben=@fuben where id =@id", conn);
